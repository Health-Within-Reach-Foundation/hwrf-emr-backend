...
const createGPRecord = {
  body: Joi.object().keys({
    ...
    hb: Joi.number().required(),
    complaints: Joi.array().items(Joi.string()).required(),
    kco: Joi.array().items(Joi.string()).required(),
    findings: Joi.array().items(Joi.string()).required(),
    systemicExamination: Joi.array().items(Joi.string()).required(),
    ...
    offlineAmount: Joi.number().required(),
    findingsOptionsDetails: Joi.object().keys({
      temperatureDetails: Joi.string().required(),
      bpDetails: Joi.string().required(),
      pulseRateDetails: Joi.string().required(),
      respiratoryRateDetails: Joi.string().required(),
      generalExaminationDetails: Joi.string().required(),
      skinLesionDetails: Joi.string().required(),
    }).required(),
    systemicExaminationOptionsDetails: Joi.object().keys({
      respiratoryDetails: Joi.string().required(),
      cardioVascularDetails: Joi.string().required(),
      cnsDetails: Joi.string().required(),
      perAbdominalExaminationDetails: Joi.string().required(),
    }).required(),
    otherComplaints: Joi.string().required(),
  }),
};
...
const updateGPRecord = {
  ...
  body: Joi.object().keys({
    ...
    hb: Joi.number().optional(),
    complaints: Joi.array().items(Joi.string()).optional(),
    kco: Joi.array().items(Joi.string()).optional(),
    findings: Joi.array().items(Joi.string()).optional(),
    systemicExamination: Joi.array().items(Joi.string()).optional(),
    ...
    offlineAmount: Joi.number().optional(),
    findingsOptionsDetails: Joi.object().keys({
      temperatureDetails: Joi.string().optional(),
      bpDetails: Joi.string().optional(),
      pulseRateDetails: Joi.string().optional(),
      respiratoryRateDetails: Joi.string().optional(),
      generalExaminationDetails: Joi.string().optional(),
      skinLesionDetails: Joi.string().optional(),
    }).optional(),
    systemicExaminationOptionsDetails: Joi.object().keys({
      respiratoryDetails: Joi.string().optional(),
      cardioVascularDetails: Joi.string().optional(),
      cnsDetails: Joi.string().optional(),
      perAbdominalExaminationDetails: Joi.string().optional(),
    }).optional(),
    otherComplaints: Joi.string().optional(),
  }).min(1),
};
